...
let yourAddress = prompt("Nhập địa chỉ của bạn: ")
let yDay = parseInt(prompt("Nhập ngày: "))
let yMonth =parseInt(prompt("Nhập tháng: "))
let yYear = parseInt(prompt("Nhập năm: "))





document.write('"' +  yourName + ' thương nhớ,')
document.write("<br>")
document.write("<br>")
document.write("<br>")
...
document.write("<br>")
document.write("<br>")
document.write(yourAddress + ', ngày ' + yDay +' tháng ' + yMonth + ' năm ' +yYear + '.')